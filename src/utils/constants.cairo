...
// Selector computed using Python's starkware.starknet.compiler.compile.get_selector_from_name("supportsInterface")
...
const SIGNER_TYPE_SECP256R1_HWS = 0x2;
const SIGNER_TYPE_SECP256R1_SWS = 0x3;
